...
plot
```
Null Hypotesis that the probability of failing in the detection of the disease is greater or equal than the one with the old method, i.e. 15%
...
(d) test the hypotesis : $H_0: p = 0.1$ versus $H1 : p \neq 0.1$
...
plot(unname(autocorr(chain, lags=c(1:50))[[1]]))
